...
>
> - `dispatch-definition/v1` — what was intended (bead, pipeline, agent)
> - `dispatch-execution/v1` — what happened (timing, work, cost)
> - `dispatch-verification/v1` — what was verified (tiers, outcome)
