//! VCS scanning and language detection helpers.
...
impl Reconciler {
    ...
    pub(crate) async fn scan_vcs(&mut self, beads: &[crate::bead::Bead]) -> usize {
        use crate::vcs;
...
pub(crate) fn detect_language(path: &std::path::Path) -> String {
