            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "acceptance_criteria": { "type": "string", "description": "Structured close condition — how 'done' is verified (a runnable command or a resolution statement). The gate checks THIS field's presence, not the description prose, so it can't be fooled by a negation. Preferred over baking the condition into the description." },
