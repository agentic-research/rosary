//! Utility methods: parsing, raw SQL execution, event logging, auto-commit.
...
impl DoltClient {
    ...
    pub(super) fn parse_files_from_notes(row: &sqlx_mysql::MySqlRow) -> (Vec<String>, Vec<String>) {
    ...
    pub(super) async fn enable_auto_dolt_commit(&self) {
    ...
    pub(super) async fn auto_commit(&self, _message: &str) {
